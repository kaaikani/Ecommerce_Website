...
import { json, redirect, type LoaderFunctionArgs, type ActionFunctionArgs } from "@remix-run/server-runtime";
...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  return json({ activeCustomer: transformedActiveCustomer, channelCode, channelPostalcodes });
}
