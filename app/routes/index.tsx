...
import {
  ...
  NavbarLogo,
  NavbarButton,
} from "~/components/ui/resizable-navbar"; // adjust the path if in subfolder
       ...
       <div className="bg-white">
        ...
        <MobileNav>
          ...
          <MobileNavMenu isOpen={isOpen} onClose={() => setIsOpen(false)}>
            ...
            <NavbarButton href="/signup" className="mt-4">
              Sign Up
            </NavbarButton>
          </MobileNavMenu>
        </MobileNav>
          ...
          {/* <header className="absolute inset-x-0 top-0 z-50">
            <nav aria-label="Global" className="flex items-center max-w-7xl mx-auto justify-between p-6 lg:px-8">
              ...
              <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                ...
                <Link
      to="/sign-in"
      className="flex w-full justify-center rounded-md max-w-32 bg-indigo-600 px-3 py-1.5 text-sm font-semibold text-white shadow hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600"
    >
              ...
              <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                ...
                <div className="mt-6 flow-root">
                  <div className="-my-6 divide-y divide-gray-500/10">
                    ...
                    <Link
      to="/sign-in"
      className="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold text-white shadow hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600"
    >
      Sign in
    </Link>
                    </div>
            ...
            <div className="relative isolate pt-14">
              ...
              <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
                <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
                  ...
                  Fresh from the Farm to Your Table              </h1>
                  <p className="mt-6 text-lg leading-8 text-gray-600">
                  Savor the goodness of organic fruits and vegetables, naturally grown and responsibly delivered.
                  </p>
                ...
                <div className="mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow">
                  <svg role="img" viewBox="0 0 366 729" className="mx-auto w-[22.875rem] max-w-full drop-shadow-xl">
                    ...
                    >
                      <img alt="" src="https://i0.wp.com/appsnipp.com/wp-content/uploads/2022/09/intro.jpg?resize=472%2C1024&ssl=1" />
                    </foreignObject>
                  </svg>
                </div>
              </div>
              ...
              <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-20 sm:rounded-3xl sm:px-10 sm:py-24 lg:py-24 xl:px-24">
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center lg:gap-y-0">
                  ...
                  <img
                    ...
                    src="https://cdn.dribbble.com/userupload/14155433/file/original-8039dab0263f3e2adc1ce8fdcb8fb030.jpg"
                    width={2432}
                    height={1442}
