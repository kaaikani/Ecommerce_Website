...
export function OrderInstructions({ orderId, initialValue = "", disabled = false }: OrderInstructionsProps) {
  ...
  return (
    <div className="mt-6 pt-6 border-t border-gray-200">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-sm font-medium text-gray-900">SpecialInstructions</h3>
      ...
      <div className="relative">
        <textarea
          ...
          maxLength={500}
        />
        <div className="absolute bottom-2 right-2 text-xs text-gray-400">{instructions.length}/500</div>
      </div>

      <p className="mt-2 text-xs text-gray-500">{t("checkout.instructionsHelp")}</p>
