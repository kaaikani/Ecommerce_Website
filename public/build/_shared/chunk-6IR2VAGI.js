...
var OrderDetailFragmentDoc = lib_default`
...
`;
var DetailedProductFragmentDoc = lib_default`
...
`;
var ListedProductFragmentDoc = lib_default`
...
`;
var LogoutDocument = lib_default`
  mutation logout {
    logout {
      success
    }
...
`;
var RegisterCustomerAccountDocument = lib_default`
...
`;
var VerifyCustomerAccountDocument = lib_default`
...
`;
var UpdateCustomerDocument = lib_default`
...
`;
var RequestUpdateCustomerEmailAddressDocument = lib_default`
...
`;
var UpdateCustomerEmailAddressDocument = lib_default`
...
`;
var UpdateCustomerAddressDocument = lib_default`
...
`;
var CreateCustomerAddressDocument = lib_default`
...
`;
var DeleteCustomerAddressDocument = lib_default`
...
`;
var UpdateCustomerPasswordDocument = lib_default`
...
`;
var ActiveChannelDocument = lib_default`
  query activeChannel {
    activeChannel {
      id
      currencyCode
...
`;
var EligibleShippingMethodsDocument = lib_default`
...
`;
var EligiblePaymentMethodsDocument = lib_default`
...
`;
var NextOrderStatesDocument = lib_default`
  query nextOrderStates {
    nextOrderStates
  }
`;
var AvailableCountriesDocument = lib_default`
...
`;
var AddPaymentToOrderDocument = lib_default`
...
`;
var TransitionOrderToStateDocument = lib_default`
  ...
  ${OrderDetailFragmentDoc}
`;
var CreateStripePaymentIntentDocument = lib_default`
  mutation createStripePaymentIntent {
    createStripePaymentIntent
  }
`;
var GenerateBraintreeClientTokenDocument = lib_default`
  query generateBraintreeClientToken {
    generateBraintreeClientToken
  }
`;
var CollectionsDocument = lib_default`
...
`;
var CollectionDocument = lib_default`
...
`;
var ActiveCustomerDocument = lib_default`
...
`;
var ActiveCustomerDetailsDocument = lib_default`
...
`;
var ActiveCustomerAddressesDocument = lib_default`
...
`;
var ActiveCustomerOrderListDocument = lib_default`
...
`;
var SetCustomerForOrderDocument = lib_default`
  ...
  ${OrderDetailFragmentDoc}
`;
var SetOrderShippingAddressDocument = lib_default`
  ...
  ${OrderDetailFragmentDoc}
`;
var SetOrderShippingMethodDocument = lib_default`
  ...
  ${OrderDetailFragmentDoc}
`;
var AddItemToOrderDocument = lib_default`
  ...
  ${OrderDetailFragmentDoc}
`;
var RemoveOrderLineDocument = lib_default`
  ...
  ${OrderDetailFragmentDoc}
`;
var AdjustOrderLineDocument = lib_default`
  ...
  ${OrderDetailFragmentDoc}
`;
var ActiveOrderDocument = lib_default`
  query activeOrder {
    activeOrder {
      ...OrderDetail
    }
  ...
  ${OrderDetailFragmentDoc}
`;
var OrderByCodeDocument = lib_default`
  ...
  ${OrderDetailFragmentDoc}
`;
var ProductDocument = lib_default`
...
`;
var SearchDocument = lib_default`
...
`;
var SearchFacetValuesDocument = lib_default`
...
//# sourceMappingURL=/build/_shared/chunk-6IR2VAGI.js.map
