...
type TypesForKey<T, K extends Key> = T extends infer I ? K extends keyof I ? I[K] : never : never;
...
type PathValue2<T, A extends keyof Pathable<T>, B extends keyof Pathable1<T, A>> = NonNull<Pathable1<T, A>>[B];
type Pathable2<T, A extends keyof Pathable<T>, B extends keyof Pathable1<T, A>> = Pathable<PathValue2<T, A, B>>;
type PathValue3<T, A extends keyof Pathable<T>, B extends keyof Pathable1<T, A>, C extends keyof Pathable2<T, A, B>> = NonNull<Pathable2<T, A, B>>[C];
